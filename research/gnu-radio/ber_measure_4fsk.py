...
# Generated: Mon May 27 13:13:50 2019
##################################################
...
class ber_measure_4fsk(gr.top_block):
    ...
    def set_symb_rate(self, symb_rate):
        ...
        self.set_samp_rate(self.symb_rate*self.samp_per_sym)
        self.set_bit_rate(float(self.symb_rate)*self.bits_per_sym)
    ...
    def set_noise_variance(self, noise_variance):
        ...
        self.analog_fastnoise_source_x_0.set_amplitude(math.sqrt(self.noise_variance))


def argument_parser():
    parser = OptionParser(option_class=eng_option, usage="%prog: [options]")
    parser.add_option(
        "-n", "--ebno-db", dest="ebno_db", type="eng_float", default=eng_notation.num_to_str(0),
...
def main(top_block_cls=ber_measure_4fsk, options=None):
    if options is None:
